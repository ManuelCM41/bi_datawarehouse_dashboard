      ...
      ">
        @if ($voucher['status'] == 'PA')
            <div class="container_01">
                <div class="header">
                    <h1 class="header_h1">CAMBIO DE PLAN !!!</h1>
                    <img class="header_img" src="{{ $message->embed($imagePathLogo) }}" alt="Icono INFOTELPerú">
                </div>
                <div class="comentario_pago">Se hizo un cambio de Plan al usuario :
        ...
        @else
            <div style="font-family: Poppins">
                ...
                <table role="content" style="padding: 80px 64px; color: #363740;">
                    <tr>
                        <td
                            style="font-weight: 600; font-size: 32px; line-height: 48px; color: #003BB3; padding-bottom: 56px">
                    ...
                    <tr>
                        <td style="padding-bottom: 30px;">
                            El cliente <strong>{{ $cliente->name }} {{ $cliente->paterno }}
                                {{ $cliente->materno }}</strong> ha realizado un pago por YAPE, por lo que se necesita
                            la confirmación lo mas pronto posible.
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding-bottom: 24px;">
                            ...
                            <ol style="margin-top: 16px;">
                                <li>Ingresa a la página de INFOTELPERU.</li>
                    ...
                    <tr>
                        <td style="padding-bottom: 24px;">
                            Para hacer la confirmación, ingrese a la pagina INFOTELPERU para realizar la confirmación.
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding-bottom: 40px">
                            <a href="#"
                                style="text-decoration: none; color: #fff; padding: 12px 32px; background: #003BB3;
                    ...
                    <tr>
                        <td style="line-height: 40px">
                            <span>Thanks</span> <br />
                            <span style="font-weight: 600">The INFOTELPERU</span>
                        </td>
                    </tr>
                    ...
                    <tr align="center">
                        <td style="background: #003BB3; padding: 40px 0;">
                            <div style="padding-bottom: 34px">
                                ...
                                <a href="#">
                                    <img src="https://res.cloudinary.com/dtsjiqrgd/image/upload/v1636712011/linked-in_gkbnuo.png"
                                        alt="linked-in-icon">
                                </a>
                            </div>
